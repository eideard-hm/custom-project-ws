                    ...
                    <div className='card-body'>
                      <div className='support-ticket media pb-1 mb-3'>
                        ...
                        <div className='media-body ml-3'>
                          ...
                          <p className='my-1'>
                            Hi, can you please add new table htmlFor advan...
                          </p>
